...
void SV_TraceGeometry( trace_t *results, const vec3_t start, vec3_t mins, vec3_t maxs, const vec3_t end, int contentmask );
// performance-oriented trace function that ignores all entities.
